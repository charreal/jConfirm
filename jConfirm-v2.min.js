...
*/
$('body').append("<div id='jConfirm'><div style='margin-bottom: 5px;'></div><a class='jYup'></a> <a class='jNope'></a></div>");$jConfirmDiv=$('#jConfirm');$jConfirmElem='undefined';function positionjAlert(){var left,right,top;left=$jConfirmElem.offset().left;right=($(window).width()-($jConfirmElem.offset().left+$jConfirmElem.outerWidth()));top=$jConfirmElem.offset().top+20;if(left<right){$jConfirmDiv.removeClass('right').css('right','').css('left',left);}else{$jConfirmDiv.addClass('right').css('left','').css('right',right);}
...
{$jConfirmDiv.slideUp('fast');}}});$('body').resize(function(){positionjAlert();});
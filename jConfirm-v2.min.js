...
*/
(function($,h,c){var a=$([]),e=$.resize=$.extend($.resize,{}),i,k="setTimeout",j="resize",d=j+"-special-event",b="delay",f="throttleWindow";e[b]=250;e[f]=true;$.event.special[j]={setup:function(){if(!e[f]&&this[k]){return false}var l=$(this);a=a.add(l);$.data(this,d,{w:l.width(),h:l.height()});if(a.length===1){g()}},teardown:function(){if(!e[f]&&this[k]){return false}var l=$(this);a=a.not(l);l.removeData(d);if(!a.length){clearTimeout(i)}},add:function(l){if(!e[f]&&this[k]){return false}var n;function m(s,o,p){var q=$(this),r=$.data(this,d);r.w=o!==c?o:q.width();r.h=p!==c?p:q.height();n.apply(this,arguments)}if($.isFunction(l)){n=l;return m}else{n=l.handler;l.handler=m}}};function g(){i=h[k](function(){a.each(function(){var n=$(this),m=n.width(),l=n.height(),o=$.data(this,d);if(m!==o.w||l!==o.h){n.trigger(j,[o.w=m,o.h=l])}});g()},e[b])}})(jQuery,this);$('body').append("<div id='jConfirm'><div style='margin-bottom: 5px;'></div><a class='jYup'></a> <a class='jNope'></a></div>");$jConfirmDiv=$('#jConfirm');$jConfirmElem='undefined';function positionjAlert(){var left,right,top;left=$jConfirmElem.offset().left;right=($(window).width()-($jConfirmElem.offset().left+$jConfirmElem.outerWidth()));top=$jConfirmElem.offset().top+20;if(left<right){$jConfirmDiv.removeClass('right').css('right','').css('left',left);}else{$jConfirmDiv.addClass('right').css('left','').css('right',right);}
$jConfirmDiv.css('top',top);}
$jConfirmDivOpen=false;$.fn.jConfirm=function(options){var options=$.extend({message:'Are you sure?',confirm:'Yup',cancel:'Nope',openNow:false,callback:function(elem){var url=elem.attr('href');if(typeof url!=='undefined'&&url!=''){var isJS=url.substr(1,11);if(isJS=='javascript:'){eval(url.replace('javascript:',''));}else{window.location.href=url;}}}},options);$this=$(this);$jConfirmCallback=options.callback;$this.on('click',function(e){e.preventDefault();$jConfirmDivOpen=true;$jConfirmElem=$(this);var link=$jConfirmElem.attr('href');$jConfirmDiv.find('div').html(options.message);$('.jYup').html(options.confirm);$('.jNope').html(options.cancel);positionjAlert();$jConfirmDiv.slideDown('fast');});if(options.openNow){$jConfirmDivOpen=true;$jConfirmElem=$(options.openNow);var link=$jConfirmElem.attr('href');$jConfirmDiv.find('div').html(options.message);$('.jYup').html(options.confirm);$('.jNope').html(options.cancel);positionjAlert();$jConfirmDiv.css('top',top).slideDown('fast');}}
...
{$jConfirmDiv.slideUp('fast');}}});$('body').resize(function(){if($jConfirmDivOpen){positionjAlert();}});